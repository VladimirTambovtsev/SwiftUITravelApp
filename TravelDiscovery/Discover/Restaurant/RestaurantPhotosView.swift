                ...
                Spacer()
                    .fullScreenCover(isPresented: $showFullscreenModal, content: {
                        ZStack(alignment: .topLeading) {
                            ...
                            Button(action: {showFullscreenModal.toggle()}, label: {
                ...
                if mode == "grid" {
                    ...
                    ForEach(photoUrlStrings, id: \.self) { urlString in
                        VStack(alignment: .leading, spacing: 8) {
                            ...
                            Text("Ut mollit consequat id excepteur adipisicing sit sit nulla nulla voluptate. Dolore do aliquip irure anim fugiat cupidatat sit ullamco sit. Quis culpa anim ad sit.")
                                .font(.system(size: 14))
